...
def main():
	lines="="*40
	print W+R+"	"+lines+""
	print W+P+"\t\t   Coded By L0rD Cr4aft (ENA CHA5SIYAN :))"+P
	print W+B+ "FACEBOOOK"+C+ "SECURITY"+R+ "HACK"+G+ "Tool"
	print W+ R+"	"+lines+"\n\n[+] "+O+"Created By L0rd Cr4aft(eni)."
	print W+R+ "NOTE:"+C+"First Select A and log in your FB"
	print W+R+ "NOTE:"+C+"jib rab l id mt3 l fb eli 7achtk bih 9bal ma tji lzebi 3asba" 
